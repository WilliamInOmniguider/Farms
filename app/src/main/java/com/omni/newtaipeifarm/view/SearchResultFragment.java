...
public class SearchResultFragment extends Fragment implements OnMapReadyCallback,
    ...
    public static SearchResultFragment newInstance(SearchFarmResult[] results, Location userLocation) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mView == null) {
            mView = inflater.inflate(R.layout.search_result_fragment_view, null, false);
        }
        ...
        mMapFragment = (SupportMapFragment) getChildFragmentManager().findFragmentById(R.id.search_result_fragment_view_map);
        ...
        backTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().remove(SearchResultFragment.this).commit();
        ...
        mRV.setAdapter(new SearchFarmResultAdapter(mContext, mResults, new SearchFarmResultAdapter.SFRViewHolderListener() {
            ...
            public void onClickItem(View itemView, int position) {
                ((AppCompatActivity) mContext).getSupportFragmentManager().beginTransaction()
                        .replace(R.id.search_result_fragment_view_fl, FarmInfoFragment.newInstance(mResults[position].toFarm()), FarmInfoFragment.TAG)
                        .addToBackStack(null)
                        .commit();
            }
